...
const BlogTemplate = () => {
    ...
    const [reqData, setReqData] = useState(contentInitialValue);
    const navigate = useNavigate();

    useEffect(() => {
        // This effect will be called whenever reqData is updated
        ...
        saveData(); // Call the function to update reqData
    },[]);

    const publishSite = async () => {
        try {
            console.log(reqData)
            const response = await axios.post('http://localhost:3001/v1/sites', reqData);
    ...
    //     const res = await axios.get(`http://localhost:3001/v1/sites/?userId=1`);
    //     console.log(res)
    // }
    // fetchSite();
    ...
    return (
        <div className="w-full">
            ...
            <section className="relative overflow-hidden py-20" contentEditable="true" id="editor">
                    ...
                    <div className="mx-auto max-w-xl lg:max-w-7xl">
                        ...
                        <div className="my-18 -mx-4 flex flex-wrap px-4">
                            <div className="mb-12 w-full px-4 lg:mb-0 lg:w-1/2">
                                <button className="group block w-full" href="#">
                                    <img
                            ...
                            <div className="w-full px-4 lg:w-1/2">
                                <button className="group mb-8 md:flex" href="#">
                                    <img
                        ...
                        <div className="w-auto p-8">
                            <button href="#">
                                <div className="inline-flex items-center">
                                    ...
                                    <span className="ml-4 text-lg font-bold">Accentus</span>
                                </div>
                            </button>
                        </div>
                        <div className="w-auto p-8">
                            <ul className="-m-5 flex flex-wrap items-center">
                                <li className="p-5">
                                    <button className="font-medium text-gray-600 hover:text-gray-700" href="#">
                                        Privacy Policy
                                    </button>
                                </li>
                                <li className="p-5">
